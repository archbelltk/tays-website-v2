...
if (mail($to, $subject, $body, $headers)) {
    ...
    $ackSubject = "We've received your application – TAYS Automation";
    $ackBody  = "Dear $firstName,\n\n";
    $ackBody .= "Thank you for applying for the $position position at TAYS Automation.\n\n";
    $ackBody .= "We have received your application and our recruitment team will carefully review it. ";
    $ackBody .= "If your profile matches our requirements, we will be in touch within 5 working days.\n\n";
    $ackBody .= "In the meantime, feel free to explore more about us at www.taysautomation.com.\n\n";
    $ackBody .= "If you have any questions, please contact us at:\n";
    $ackBody .= "  Email: tinashe@taysautomation.com\n";
    $ackBody .= "  Phone: +44 330 133 5282\n\n";
    $ackBody .= "We wish you the best of luck!\n\n";
    $ackBody .= "Kind regards,\n";
    $ackBody .= "The TAYS Automation Recruitment Team\n";
